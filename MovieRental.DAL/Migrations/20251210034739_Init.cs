        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GenreTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PosterImageUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    LovePercentage = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ...
                    RentalDurationDays = table.Column<int>(type: "int", nullable: false, defaultValue: 30),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeRestriction = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CurrencyId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieSocialLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieSocialLinks_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Writers = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShareLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ShareLogs_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserListMovies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserListMovies_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserListMovies_UserLists_UserListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserWatchlists_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserWatchlists_Movies_MovieId1",
                        column: x => x.MovieId1,
                        principalTable: "Movies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventArtists", x => new { x.ArtistsId, x.EventId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportTranslations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieVideoTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieVideoTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovieVideoTranslations_MovieVideos_MovieVideoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewReactions_Reviews_ReviewId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SliderTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenreTranslations_LanguageId",
                table: "GenreTranslations",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieSocialLinks_MovieId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieTranslations_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieVideoTranslations_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferTranslations_OfferId",
                table: "OfferTranslations",
                column: "OfferId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewReactions_ReviewId1",
                table: "ReviewReactions",
                column: "ReviewId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShareLogs_MovieId",
                table: "ShareLogs",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareLogs_UserId",
                table: "ShareLogs",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SliderTranslations_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sports_CurrencyId",
                table: "Sports",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Sports_EventDate",
                table: "Sports",
                column: "EventDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserListMovies_MovieId",
                table: "UserListMovies",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_UserListMovies_UserListId_MovieId",
                table: "UserListMovies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWatchlists_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWatchlists_MovieId1",
                table: "UserWatchlists",
                column: "MovieId1");
